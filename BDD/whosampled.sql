...
--
-- Hôte : localhost:8889
-- Généré le : mer. 06 mars 2024 à 10:25
...
(5, 'Model 500', NULL),
(6, 'Bar-Kays', ''),
(7, 'Vaughan Mason & Crew', NULL),
(8, 'Tata Vega', NULL),
(9, 'Tupac', NULL),
(10, 'Zero-G', NULL),
(11, 'Vaughan Mason & Crew', NULL),
(12, 'Viola Wills', NULL),
(13, 'Billy Joel', NULL),
(14, '	\r\nKaren Young', NULL),
(15, 'Elton John & Kiki Dee', NULL),
(16, 'Fun Factory', NULL),
(17, '	\r\nPrince', NULL),
(18, 'Barry White', NULL);
...
INSERT INTO `sample` (`id`, `audio_sample_file`, `sample_song_origin`, `sample_artist_origin`, `song_name`) VALUES
(1, 'sample_01.mp3', 'Rapper\'s Delight', 'Sugarhill Gang', 'Around the World'),
(2, 'sample_02.mp3', 'Good Times', 'Chic', 'Around the World'),
(3, 'sample_03.mp3', 'Down to Love Town', 'Originals', 'Burnin\''),
(4, 'sample_04.mp3', '# bruitage #', 'Model 500', 'Burnin\''),
(5, 'sample_05.mp3', 'Freaky Behavior', 'Bar-Kays', 'Burnin\''),
(6, 'sample_06.mp3', 'I\'m Gonna Love You Just a Little More, Babe', 'Barry White', 'Da Funk'),
(7, 'sample_07.mp3', 'Bounce, Rock, Skate, Roll', 'Vaughan Mason & Crew', 'Da Funk'),
(8, 'sample_08.mp3', 'Get It Up for Love', 'Tata Vega', 'Da Funk'),
(9, 'sample_09.mp3', 'Bomb First (My Second Reply)', 'Tupac', 'Da Funk'),
(10, 'sample_10.mp3', '63 - Dance Stabs - House Stab 1', 'Zero-G', 'Da Funk'),
(11, 'sample_11.mp3', 'Bounce, Rock, Skate, Roll', 'Vaughan Mason & Crew', 'Daftendirekt'),
(12, 'sample_12.mp3', 'If You Leave Me Now', 'Viola Wills', 'Fresh'),
(13, 'sample_13.mp3', 'Just the Way You Are', 'Billy Joel', 'High Fidelity'),
(14, 'sample_14.mp3', 'Hot Shot', 'Karen Young', 'Indo Silver Club'),
(15, 'sample_15.mp3', 'Don\'t Go Breaking My Heart', 'Elton John & Kiki Dee', 'Phoenix'),
(16, 'sample_16.mp3', 'Celebration (Mousse T\'s Back to the Old School)', 'Fun Factory', 'Revolution 909'),
(17, 'sample_17.mp3', 'Head', 'Prince', 'Teachers'),
(18, 'sample_18.mp3', 'If You Leave Me Now', 'Viola Wills', 'Teachers');
